...
#  3.Open another terminal and write "python test_shorten.py" (will run the test_shorten.py file)
#  4.You will get the output, write the short code in the browser "http://127.0.0.1:8000/r/short code"